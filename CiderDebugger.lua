local CiderRunMode = {};CiderRunMode.runmode = true;CiderRunMode.sdk = "Corona";CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/johnsykes/Library/Application Support/LuaGlider/dev";local CORONA_SOCKET_PORT=51248;local SOCKET_PORT=51249;local GLIDER_MAIN_FOLDER= "/Users/johnsykes/Documents/Projects/CoronaSDK/Pacemaker";local useNativePrint= false;
--v1.70
-----------------------------------------------------------------------------------------
--
-- main.lua
